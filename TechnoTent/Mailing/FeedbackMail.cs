    ...
    public class FeedbackMail
    {
        public static void SendMail(FeedbackVM feedbackVM)
        {
            try
            {
                ...
                MailAddress from = new MailAddress("tehnotentdn@gmail.com", feedbackVM.Name);
                // кому отправляем
