    ...
    public class BackCall
    {
        public static void SendMail(BackCallVM backCallVM)
        {
            try
            {
                ...
                MailAddress from = new MailAddress("tehnotentbot@gmail.com", backCallVM.Name);
                // кому отправляем
                MailAddress to = new MailAddress("tehnotentbot@gmail.com");
                ...
                {
                    // логин и пароль
                    Credentials = new NetworkCredential("tehnotentbot@gmail.com", "qwe123123@"),
                    EnableSsl = true
                };
