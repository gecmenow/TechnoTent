    ...
    public class Order
    {
        public static void SendMail(OrderVM order)
        {
            try
            {
                ...
                MailAddress from = new MailAddress("tehnotentdn@gmail.com", "Техно Тент");
                // кому отправляем
